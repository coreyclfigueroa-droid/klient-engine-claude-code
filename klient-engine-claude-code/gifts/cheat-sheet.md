...
| `/klient-engine:lesson-1` through `/klient-engine:lesson-5` | Run course lessons |
| `/klient-engine:skill-builder` | Build new skills from scratch (Gift from Lesson 2) |
| `/klient-engine:summarize` | Summarize any content |
| `/klient-engine:repurpose` | Repurpose content for multiple platforms |
...
**How to create one:**
1. Type `/klient-engine:skill-builder`
...
| Gift | Location | From |
|------|----------|------|
| 30 Prompts That Print Money | `~/.klient-engine/gifts/30-prompts-that-print-money.md` | Lesson 1 |
| Skill Builder (skill) | `/klient-engine:skill-builder` | Lesson 2 |
| 5 Agent Workflows | `~/.klient-engine/gifts/5-agent-workflows.md` | Lesson 4 |
| Business-in-a-Box Prompt Pack | `~/.klient-engine/gifts/business-in-a-box.md` | Lesson 5 |
| This Cheat Sheet | `~/.klient-engine/gifts/cheat-sheet.md` | Lesson 6 |
...
→ Re-run the installer: `bash <(curl -fsSL https://raw.githubusercontent.com/noe-varner/Klient-Engine-Free-Claude-Code/main/install.sh)`
...
- `/klient-engine:skill-builder` to create unlimited custom skills
- `/klient-engine:summarize` and `/klient-engine:repurpose` utility skills

**Want to go deeper?**
- Join the community: https://www.skool.com/klient-engine-premium/about
- Premium system: 4 courses, 22 skills, live calls, community
- Follow @klientengine for daily tutorials
