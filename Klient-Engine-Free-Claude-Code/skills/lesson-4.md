...
1. **Push to Airtable** — create a new record with:
...
- If custom → ask: **"Got reference images? Drop them in. If not, just describe what you want the avatar to look like."** → STOP and WAIT → store their input.
...
- If custom → ask: **"Describe the environment — where's your avatar standing?"** → STOP and WAIT → store their input.
...
1. **Push to Airtable** — avatar, image URL, environment, all 5 hooks, status "Image Generated"
...
╔═══════════════════════════════════════════════════════════╗
║                                                           ║
║   🎁 GIFT UNLOCKED: AI Content Pipeline                   ║
║                                                           ║
║   Master orchestration skill:                             ║
║                                                           ║
║   📄 What it does:                                        ║
║   - Writes viral hooks from your framework                ║
║   - Selects avatar from your Airtable library             ║
║   - Picks environment from your Airtable packs (or cust) ║
║   - Generates image via fal.ai                            ║
║   - Logs everything to Airtable                           ║
║   - Best hook = video script (short & punchy)             ║
║   - Asks for confirmation before finalizing               ║
║                                                           ║
║   🔮 Full viral scripts come from the orchestration       ║
║   skill — powered by Manus-scraped IG scripts.            ║
║   That's the next level.                                  ║
║                                                           ║
║   🔗 References:                                          ║
║   - /skills/viral-hooks/SKILL.md                          ║
║   - /skills/ai-avatars/SKILL.md                           ║
║   - /skills/environment-packs/SKILL.md                    ║
║   - /skills/fal-ai-image/SKILL.md                         ║
║   - /skills/airtable-pipeline/SKILL.md                    ║
║                                                           ║
║   ~/.klient-engine/gifts/ai-content-pipeline.md           ║
║                                                           ║
╚═══════════════════════════════════════════════════════════╝
```
...
**This is the whole thing.** One skill file that runs your content production pipeline.

Call it once. Give it a topic, pick your avatar from Airtable, pick your environment. **It handles the rest.**

Hooks get written. Image gets generated. Everything logs to Airtable. **The best hook IS your video script — short, punchy, scroll-stopping.**

**Full viral scripts?** That's the orchestration skill — powered by real IG scripts scraped by Manus. That's coming. 😏

Want to see the pipeline skill? Just say **"show me the pipeline skill"** and I'll pull it up.
