#!/bin/bash
# Klient-Engine Free Claude Code — One-Command Installer
...
INSTALL_DIR="$HOME/.klient-engine"
SKILL_DIR="$HOME/.claude/commands/klient-engine"

echo ""
echo "  Klient-Engine Free Claude Code"
echo "  ======================"
echo ""
...
if [ -d "$INSTALL_DIR" ]; then
    ...
    echo "  Downloading Klient-Engine Free Claude Code..."
...
echo "  ├── Skills → ~/.claude/commands/klient-engine/"
echo "  ├── Course → ~/.klient-engine/course/"
echo "  ├── Gifts → ~/.klient-engine/gifts/"
echo "  └── CLAUDE.md Templates → ~/.klient-engine/claude-md-templates/"
echo ""
echo "  To get updates, just re-run this command."
echo "  The installer pulls the latest from GitHub automatically."
echo ""
echo "  ─────────────────────────────────────────────"
echo "  Premium community: https://www.skool.com/klient-engine-premium/about"
...
echo "    claude"
echo ""
echo "  Then type:  /klient-engine:start"
echo ""
