...
Built by [@noevarner.ai](https://instagram.com/noevarner.ai)
...
**macOS / Linux / WSL:**
```
curl -fsSL https://raw.githubusercontent.com/noe-varner/Klient-Engine-Free-Claude-Code/main/install.sh | bash
```

**Windows (PowerShell):**
```
irm https://raw.githubusercontent.com/noe-varner/Klient-Engine-Free-Claude-Code/main/install.ps1 | iex
```
