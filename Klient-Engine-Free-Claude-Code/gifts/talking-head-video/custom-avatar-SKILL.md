...
Search the AI Avatars table for an existing record with this Name. If found, update it. If not, create a new record.
...
Confirm to the user:
> "✅ **[AVATAR_NAME]** has been saved as a skill file and added to your Airtable avatar gallery. They're ready to use in any future talking head video."
