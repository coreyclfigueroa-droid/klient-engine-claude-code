# Klient-Engine Free Claude Code — One-Command Installer (Windows)
# Installs free skills, templates, and resources

$REPO = "noe-varner/Klient-Engine-Free-Claude-Code"
$REPO_URL = "https://github.com/$REPO.git"
$INSTALL_DIR = "$env:USERPROFILE\.klient-engine"
$SKILL_DIR = "$env:USERPROFILE\.claude\commands\klient-engine"

Write-Host ""
Write-Host "  Klient-Engine Free Claude Code"
Write-Host "  ======================"
Write-Host ""
...
try {
    if (Test-Path $INSTALL_DIR) {
        ...
        Write-Host "  Downloading Klient-Engine Free Claude Code..."
...
foreach ($skill in $skillFiles) {
    ...
    Write-Host "    OK /klient-engine:$skillName"
    $SKILL_COUNT++
}
...
Write-Host "  +-- Skills -> ~\.claude\commands\klient-engine\"
Write-Host "  +-- Course -> ~.klient-engine\course\"
Write-Host "  +-- Gifts -> ~.klient-engine\gifts\"
Write-Host "  +-- CLAUDE.md Templates -> ~.klient-engine\claude-md-templates\"
Write-Host ""
Write-Host "  To get updates, just re-run this command."
Write-Host "  The installer pulls the latest from GitHub automatically."
Write-Host ""
Write-Host "  -----------------------------------------"
Write-Host "  Premium community: https://www.skool.com/klient-engine-premium/about"
...
Write-Host "    claude"
Write-Host ""
Write-Host "  Then type:  /klient-engine:start"
Write-Host ""
